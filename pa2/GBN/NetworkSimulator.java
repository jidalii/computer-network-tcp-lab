...
public abstract class NetworkSimulator
{
    ...
    private int nSim;
    private int nToLayer3; // this variable denotes the times of packets are transmitted between A and B
    public int nToLayer3FromA;
    private int nToLayer5; // this variable denotes the times of packets are delivered to B-side upper layer
    private int nLost;
    ...
    protected int getToLayer3() {
        return nToLayer3;
    }

    protected int getToLayer5() {
        return nToLayer5;
    }
